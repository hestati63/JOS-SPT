...
void vmexit() {
	...
	#ifdef PERF_TEST
	static int counter_all = 0, counter_nmi = 0, counter_movcr = 0, counter_invlpg = 0;
	#endif
	...
	#ifdef PERF_TEST
	cprintf("Counter all: %d, nmi: %d, movcr: %d, invlpg: %d\n", ++counter_all, counter_nmi, counter_movcr, counter_invlpg);
	#endif
